...
class Control(abstract_experiment.Experiment):
    ...
    def inverse(self, x):
        """Returns the inverse of the function, x, passed
        ...
        -------
        int
            The inverse of x, the number passed
        """
        array = x.copy()
    ...
    def get_pset(self, num_predictors, variable_type_indices, names, variable_dict):
        ...
        pset.addPrimitive(symbreg.numpy_protected_div_one, 2)
        pset.addPrimitive(self.inverse, 1)
